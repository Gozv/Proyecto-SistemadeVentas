...
public partial class DbventasContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4830C31CA5D");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1079E829DF1");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E4FB1FB94");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132816946F7");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76779B2AFD");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D84D279ED9");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6EFDA7B7E");
